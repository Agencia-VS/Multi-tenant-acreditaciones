  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
        <Link href="/acreditado/dashboard" className="p-4 sm:p-6 bg-accent-light rounded-xl border border-accent-light hover:bg-accent-light/80 transition">
          <i className="fas fa-ticket-alt text-xl sm:text-2xl text-brand mb-2" />
        ...
        <Link href="/acreditado/perfil" className="p-4 sm:p-6 bg-purple-50 rounded-xl border border-purple-100 hover:bg-purple-100 transition">
          <i className="fas fa-user-edit text-xl sm:text-2xl text-purple-600 mb-2" />
          <h3 className="font-bold text-heading text-sm sm:text-base">Mi Perfil</h3>
          <p className="text-xs sm:text-sm text-body mt-1">Actualizar mis datos personales</p>
        </Link>
      </div>
      ...
      {/* Active Events */}
      <h2 className="text-lg sm:text-xl font-bold text-heading mb-3 sm:mb-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-0 sm:justify-between">
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-bold text-heading text-sm sm:text-base truncate">{event.nombre}</h3>
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-body mt-1">
                        ...
                        {event.venue && <span className="hidden sm:inline"><i className="fas fa-map-marker-alt mr-1" />{event.venue}</span>}
                      </div>
