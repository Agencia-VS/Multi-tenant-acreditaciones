...
export async function POST(req: Request) {
  try {
    const { 
      ...
      zona, 
      area,
      // Colores del tenant (opcionales, con fallbacks)
      tenantColors = {},
      tenantName = 'Universidad Católica',
    ...
    const instruccionesAcceso = zona === "Cancha" 
      ? `
        <h3 style="color: ${colors.primario}; margin: 20px 0 10px 0; font-size: 16px;">Acceso Reporteros Gráficos:</h3>
      ...
      `
      : `
        <h3 style="color: ${colors.primario}; margin: 20px 0 10px 0; font-size: 16px;">Acceso: Acreditación Prensa</h3>
        <p style="margin: 0 0 15px 0; color: #4b5563; line-height: 1.6;">
    ...
    const informacionComun = `
      <h3 style="color: ${colors.primario}; margin: 20px 0 10px 0; font-size: 16px;">Información General</h3>
      ...
      <h3 style="color: ${colors.primario}; margin: 20px 0 10px 0; font-size: 16px;">Requisitos de ingreso</h3>
      ...
      <h3 style="color: ${colors.primario}; margin: 20px 0 10px 0; font-size: 16px;">Normas de cobertura</h3>
      <ul style="margin: 0 0 15px 0; padding-left: 20px; color: #4b5563; line-height: 1.6;">
      ...
      <h3 style="color: ${colors.primario}; margin: 20px 0 10px 0; font-size: 16px;">Estacionamientos</h3>
      <p style="margin: 0 0 15px 0; color: #4b5563; line-height: 1.6;">
            ...
            <tr>
              <td align="center">
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); overflow: hidden; max-width: 100%;">
                  ...
                  <!-- Header con gradiente dinámico del tenant -->
                  <tr>
                    <td style="background: linear-gradient(135deg, ${colors.primario} 0%, ${colors.dark} 50%, ${colors.light} 100%); padding: 40px 30px; text-align: center;">
                      <h1 style="color: #ffffff; font-size: 28px; margin: 0 0 10px 0; font-weight: 700;">
                        <img src="${tenantLogo}" alt="Logo ${tenantName}" style="height: 70px; margin-bottom: 10px;" />
                      </h1>
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                        <tr>
                          <td style="padding: 20px; background-color: #eff6ff; border-left: 4px solid ${colors.primario}; border-radius: 8px; margin-bottom: 15px;">
                            ...
                            <p style="margin: 0; color: ${colors.primario}; font-size: 18px; font-weight: 700;">
                              ${area}
                            </p>
                          </td>
                        </tr>
                      ...
                      <div style="background-color: #eff6ff; border-left: 4px solid ${colors.primario}; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
