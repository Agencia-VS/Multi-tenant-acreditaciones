        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10 backdrop-blur-xl border border-blue-100">
            ...
            <div className="relative w-48 h-20">
              {tenant.shield_url ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <span className="text-2xl font-bold\" style={{ color: colors.primario }}>
                    {tenant.nombre}
                  </span>
                </div>
              )}
          ...
          <form onSubmit={login} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl hover:shadow-lg text-white font-semibold px-4 py-3.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]"
              style={{ background: `linear-gradient(to right, ${colors.primario}, ${colors.dark}, ${colors.light})` }}
            >
              {loading ? (
                <>
